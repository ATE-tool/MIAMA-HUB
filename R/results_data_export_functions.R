...
.results_export_markdown <- function(exports, pdf = FALSE) {
  ...
  c(
    ...
    "",
    "## Full method and assumptions reference",
    "",
    # Fixed documentation links, separate from escaped user/profile text.
    paste0("See the [MIAMA-HUB methodology](https://github.com/ATE-tool/MIAMA-HUB/blob/dev/docs/current/documentation/methodology.qmd) ",
      "and [assumption field catalogue](https://github.com/ATE-tool/MIAMA-HUB/blob/dev/docs/current/documentation/appraisal_assumptions_field_catalogue.md) ",
      "for exposure intensity, sampling priorities, fallbacks and health aggregation. ",
      "These describe the method; this report is not a full serialized appraisal profile."),
    "",
    "## Appraisal metadata",
    "",
