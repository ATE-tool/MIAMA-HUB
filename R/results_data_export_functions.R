...
.results_export_markdown <- function(exports, pdf = FALSE) {
  ...
  c(
    ...
    paste0("See the [MIAMA-HUB methodology](https://github.com/ATE-tool/MIAMA-HUB/blob/dev/docs/methodology.qmd) ",
      "and [assumption field catalogue](https://github.com/ATE-tool/MIAMA-HUB/blob/dev/docs/appraisal_assumptions_field_catalogue.md) ",
