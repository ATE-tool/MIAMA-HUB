...
Sources: docs/methodology.qmd, Reference synthetic population; README.md, Tab 1 and runtime data profiles.
:::
...
Sources: R/tab2_input_conversion.R; docs/methodology.qmd, Basic specification and Continuity from Tab 2 to Tabs 3 and 4.
:::
...
Sources: R/api_refinement_profile_defaults.R; R/counterfactual_data_apply_ui_values.R; docs/methodology.qmd, Continuity and Counterfactual sampling and redistribution.
:::
...
Sources: R/counterfactual_data_apply_health_outcomes.R; docs/methodology.qmd, From physical activity to health trajectories and Health-adjusted life years.
:::
...
Sources: R/results_data_prepare.R; README.md, Tab 5: Present and export results; docs/methodology.qmd, Validation, uncertainty, and remaining work.
:::
...
Full-resolution diagram: [User-count route](ui_data_authority_workflow_png/01-user-count-route.png). Open the original PNG and zoom for detailed discussion. Source: docs/ui_data_authority_workflow_diagrams.qmd.
:::
...
Full-resolution diagram: [Trip-count route](ui_data_authority_workflow_png/02-trip-count-route.png). Source: docs/ui_data_authority_workflow_diagrams.qmd.
:::
...
Full-resolution diagram: [Distance/duration route](ui_data_authority_workflow_png/03-distance-duration-route.png). Source: docs/ui_data_authority_workflow_diagrams.qmd.
:::
...
Full-resolution diagram: [Mode-share route](ui_data_authority_workflow_png/04-mode-share-route.png). Source: docs/ui_data_authority_workflow_diagrams.qmd.
:::
...
Full-resolution diagram: [Tab 3 to results](ui_data_authority_workflow_png/05-tab3-to-results-handoff.png). Source: docs/ui_data_authority_workflow_diagrams.qmd.
:::
...
Full-resolution diagram: [Complete workflow](ui_data_authority_workflow_png/06-comprehensive-workflow.png). Source: docs/ui_data_authority_workflow_diagrams.qmd. The diagrams describe the intended data-authority workflow; use the sampling slide and its notes for current fallback details and implementation nuances.
:::
